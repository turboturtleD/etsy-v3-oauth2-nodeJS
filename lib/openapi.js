    ...
    "paths": {
                        ...
                        "application/x-www-form-urlencoded": {
                            "schema": {
                                ...
                                "properties": {
                                    ...
                                    "publish": {
                                        "type": "boolean",
                                        "description": "Indicates whether this listing should be published or not.",
                                        "default": false
                                    },
                                    "type": {
                                        "type": "string",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "shop_location",
                        "in": "query",
                        "description": "Filters by shop location. If location cannot be parsed, an error will be thrown.",
                        "required": false,
                        "schema": {
                            "type": "string",
                            "description": "Filters by shop location. If location cannot be parsed, an error will be thrown.",
        ...
        "/v3/application/listings/shipping-profiles/destinations": {
            "post": {
                ...
                "description": "<div class=\"wt-display-flex-xs wt-align-items-center wt-mt-xs-2 wt-mb-xs-3\"><span class=\"wt-badge wt-badge--notification-03 wt-mr-xs-2\">Alpha</span><a class=\"wt-text-link\" href=\"https://github.com/etsy/open-api/issues/new/choose\" target=\"_blank\" rel=\"noopener noreferrer\">Give feedback</a></div><div class=\"wt-display-flex-xs wt-align-items-center wt-mt-xs-2 wt-mb-xs-3\"><p class=\"wt-text-body-01 banner-text\">This endpoint is ready for use as defined below, but is access-controlled and may change significantly before launch. If you'd like access, please email <a href=\"mailto:developers@etsy.com\" class=\"wt-text-link\" target=\"_blank\">developers@etsy.com</a>.</p></div>\n\nCreates a new ListingShippingProfileDestination, which sets costs for a shipping destination in a <a class=\"wt-text-link\" href=\"#tag/ShopListing-ShippingProfile\">ListingShippingProfile</a>. createListingShippingProfileDestination assigns costs using the currency of the associated Shop. Set the destination using either destination_country_iso or destination_region; destination_country_iso and destination_region are mutually exclusive - set one or the other, Setting both triggers error 400. If the request sets neither destination_country_iso nor destination_region, the default destination is \"everywhere\".",
                "tags": ["ShopListing ShippingProfile"],
                "requestBody": {
                    "content": {
                        "application/x-www-form-urlencoded": {
                            "schema": {
                                ...
                                "properties": {
                                    ...
                                    "destination_country_iso": {
                                        "type": "string",
                                        "description": "The ISO code of the country to which the listing ships. If null, request sets destination to destination_region, or \"everywhere\" if destination_region is also \"none\".",
                                        "format": "ISO 3166-1 alpha-2",
                                        "default": null
                                    },
                                    "destination_region": {
