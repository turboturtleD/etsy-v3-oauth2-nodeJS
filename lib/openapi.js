    ...
    "paths": {
                        ...
                        "application/x-www-form-urlencoded": {
                            "schema": {
                                ...
                                "properties": {
                                    ...
                                    "title": {
                                        "type": "string",
                                        "description": "The listing's title string. Valid title strings contain only letters, numbers, punctuation marks, mathematical symbols, whitespace characters, ™, ©, and ®. (regex: /[^\\p{L}\\p{Nd}\\p{P}\\p{Sm}\\p{Zs}™©®]/u) You can only use the %, :, & and + characters once each."
                                    },
                                    "description": {
                                        "type": "string",
                                    ...
                                    "price": {
                                        "type": "number",
                                        "description": "The positive non-zero price of the product. (Sold product listings are private) Note: The price is the minimum possible price. The getInventory method requests exact prices for available offerings.",
                                        "format": "float",
                                        "minimum": 0.2,
                                        "maximum": 50000
                                    },
                                    "who_made": {
                                        "type": "string",
                                        "description": "An enumerated string inidcated who made the product. Helps buyers locate the listing under the Handmade heading. Requires 'is_supply' and 'when_made'.",
                                        "enum": [
                                            "i_did",
                                            "someone_else",
                                            "collective"
                                    ...
                                    "taxonomy_id": {
                                        "type": "integer",
                                        "description": "The numeric taxonomy ID of the listing. The seller manages listing taxonomy IDs for their shop.  [See SellerTaxonomy](/documentation/reference#tag/SellerTaxonomy) for more information.",
                                        "minimum": 1
                                    },
                                    "shipping_profile_id": {
                                        "type": "integer",
                                        "description": "The numeric ID of the [shipping profile](/documentation/reference#tag/ShopListing-ShippingProfile) associated with the listing.",
                                        "minimum": 1
                                    },
                                    "materials": {
                                        "type": "array",
                                    ...
                                    "tags": {
                                        "type": "array",
                                        "description": "A list of tag strings for the listing. Valid tag strings contain only letters, numbers, whitespace characters, -, ', ™, ©, and ®. (regex: /[^\\p{L}\\p{Nd}\\p{Zs}\\-'™©®]/u) Default value is null.",
                                        "nullable": true,
                                        "items": {
                                            "type": "string",
                                            "nullable": true
                                    ...
                                    "styles": {
                                        "type": "array",
                                        "description": "An array of style strings for this listing, each of which is free-form text string such as \"Formal\", or \"Steampunk\". A Listing may have up to two styles. Valid style strings contain only letters, numbers, and whitespace characters. (regex: /[^\\p{L}\\p{Nd}\\p{Zs}]/u) Default value is null.",
                                        "nullable": true,
                                        "items": {
                                            "type": "string",
                                            "nullable": true
                                    ...
                                    "personalization_is_required": {
                                        "type": "boolean",
                                        "description": "When true, this listing requires personalization. The default value is null."
                                    },
                                    "personalization_char_count_max": {
                                        "type": "integer",
                                        "description": "This an integer value representing the maximum length for the personalization message entered by the buyer."
                                    },
                                    "personalization_instructions": {
                                        "type": "string",
                                        "description": "A string representing instructions for the buyer to enter the personalization."
                                    },
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "state",
                        "in": "query",
                        "description": "An enumerated string from any of: active or inactive. Note: Setting a draft listing to active will also publish the listing on etsy.com.",
                        "required": false,
                        "schema": {
                            "type": "string",
                            "description": "An enumerated string from any of: active or inactive. Note: Setting a draft listing to active will also publish the listing on etsy.com.",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "includes",
                        "in": "query",
                        "description": "An enumerated string that attaches a valid association. Acceptable inputs are 'shop', 'images' and 'user'. Default value is an empty array.",
                        "required": false,
                        "schema": {
                            "type": "array",
                            "description": "An enumerated string that attaches a valid association. Acceptable inputs are 'shop', 'images' and 'user'. Default value is an empty array.",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "includes",
                        "in": "query",
                        "description": "An enumerated string that attaches an valid association. Default value is null.",
                        "required": false,
                        "schema": {
                            "type": "string",
                            "description": "An enumerated string that attaches an valid association. Default value is null.",
                                    ...
                                    "products": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                ...
                                                "property_values": {
                                                    "type": "array",
                                                    "description": "A list of property value entries for this product.",
                                                    "items": {
                                                        "type": "object",
                                                        "properties": {
                                                            "property_id": {
                        ...
                        "application/x-www-form-urlencoded": {
                            "schema": {
                                ...
                                "properties": {
                                    ...
                                    "values": {
                                        "type": "array",
                                        "description": "An array of value strings for multiple Etsy [listing property](/documentation/reference#operation/getListingProperties) values. For example, if your listing offers different colored products, then the values array contains the color strings for each color.",
                                        "items": {
                                            "type": "string"
                                        }
                                    },
        ...
        "/v3/application/shops/{shop_id}/payments": {
            "get": {
                ...
                "description": "<div class=\"wt-display-flex-xs wt-align-items-center wt-mt-xs-2 wt-mb-xs-3\"><span class=\"wt-badge wt-badge--notification-03 wt-bg-slime-tint wt-mr-xs-2\">General Release</span><a class=\"wt-text-link\" href=\"https://github.com/etsy/open-api/issues/new/choose\" target=\"_blank\" rel=\"noopener noreferrer\">Report bug</a></div><div class=\"wt-display-flex-xs wt-align-items-center wt-mt-xs-2 wt-mb-xs-3\"><p class=\"wt-text-body-01 banner-text\">This endpoint is ready for production use.</p></div>\n\nRetrives a list of payments from a shop identified by `shop_id`. You can also filter results using a list of payment IDs.",
                "tags": ["Payment"],
                "parameters": [
                    {
                        "name": "shop_id",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "was_paid",
                        "in": "query",
                        "description": "When true, the seller recieved payment for the product(s) in this receipt.",
                        "required": false,
                        "schema": {
                            "type": "boolean",
                            "description": "When true, the seller recieved payment for the product(s) in this receipt."
                    ...
                    },
                    {
                        "name": "was_shipped",
                        "in": "query",
                        "description": "When true, the seller shipped the product(s) in this receipt.",
                        "required": false,
                        "schema": {
                            "type": "boolean",
                            "description": "When true, the seller shipped the product(s) in this receipt."
        ...
        "/v3/application/shops/{shop_id}/reviews": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A set of TransactionReviews",
                        "content": {
                            "application/json": {
                                "schema": {
                            ...
                            "schema": {
                                ...
                                "properties": {
                                    ...
                                    "destination_country_iso": {
                                        "type": "string",
                                        "description": "The ISO code of the country to which the listing ships. If null, request sets destination to destination_region",
                                        "format": "ISO 3166-1 alpha-2",
                                        "default": null
                                    },
                                    "destination_region": {
                                        "type": "string",
                                        "description": "The code of the region to which the listing ships. A region represents a set of countries. Supported regions are Europe Union and Non-Europe Union (countries in Europe not in EU). If \"none\", request sets destination to destination_country_iso, or \"everywhere\" if destination_country_iso is also null",
                                        "enum": ["eu", "non_eu", "none"],
                                        "default": "none"
                                    },
                                    "origin_postal_code": {
                                        "type": "string",
                                        "description": "The postal code string (not necessarily a number) for the location from which the listing ships.",
                                        "default": ""
                                    },
                                    "shipping_carrier_id": {
                                        "type": "integer",
                                        "description": "The unique ID of a supported shipping carrier, which is used to calculate an Estimated Delivery Date.",
                                        "minimum": 0,
                                        "default": 0
                                    },
                                    "mail_class": {
                                        "type": "string",
                                        "description": "The unique ID string of a shipping carrier's mail class, which is used to calculate an estimated delivery date.",
                                        "default": null
                                    },
                                    "min_delivery_days": {
                                        "type": "integer",
                                        "description": "The minimum number of business days a buyer can expect to wait to receive their purchased item once it has shipped.",
                                        "minimum": 1,
                                        "maximum": 45,
                                        "default": null
                                    },
                                    "max_delivery_days": {
                                        "type": "integer",
                                        "description": "The maximum number of business days a buyer can expect to wait to receive their purchased item once it has shipped.",
                                        "minimum": 1,
                                        "maximum": 45,
                                        "default": null
                                    }
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "path",
                        "description": "The numeric ID of the shipping profile destination in the [shipping profile](/documentation/reference#tag/ShopListing-ShippingProfile) associated with the listing.",
                        "required": true,
                        "schema": {
                            "type": "integer",
                            "description": "The numeric ID of the shipping profile destination in the [shipping profile](/documentation/reference#tag/ShopListing-ShippingProfile) associated with the listing.",
        ...
        "schemas": {
            "ShopListing": {
                ...
                "properties": {
                    ...
                    "is_private": {
                        "type": "boolean",
                        "description": "When true, this is a private listing intendend for a specific buyer and hidden from shop view."
                    },
                    "style": {
                        "type": "array",
                        "description": "An array of style strings for this listing, each of which is free-form text string such as \\\"Formal\\\", or \\\"Steampunk\\\". A Listing may have up to two styles. Valid style strings contain only letters, numbers, and whitespace characters. (regex: /[^\\\\p{L}\\\\p{Nd}\\\\p{Zs}]/u) Default value is null.",
            ...
            "User": {
                ...
                "properties": {
                    ...
                    "login_name": {
                        "type": "string",
                        "description": "The user\\'s login name string."
                    },
                    "primary_email": {
                        "type": "string",
                    ...
                    "create_timestamp": {
                        "type": "integer",
                        "description": "The date and time the user created their account, in epoch seconds.",
                        "minimum": 946684800
                    },
                    "referred_by_user_id": {
                        "type": "integer",
                        "description": "The numeric ID of the user who referred this user.",
                        "nullable": true,
                        "minimum": 1
                    },
                    "use_new_inventory_endpoints": {
                    ...
                    "is_seller": {
                        "type": "boolean",
                        "description": "True if the user is seller."
                    },
                    "bio": {
                        "type": "string",
                    ...
                    "birth_month": {
                        "type": "string",
                        "description": "The user\\'s month of birth.",
                        "nullable": true
                    },
                    "birth_day": {
                        "type": "string",
                        "description": "The user\\'s day of birth.",
                        "nullable": true
                    },
                    "transaction_buy_count": {
                        "type": "integer",
                        "description": "The number of transactions where the user has bought.",
                        "nullable": true,
                        "minimum": 0
                    },
                    "transaction_sold_count": {
                        "type": "integer",
                        "description": "The number of transactions where the user has sold.",
                        "nullable": true,
                        "minimum": 0
                    }
                }
            ...
            "Shop": {
                ...
                "properties": {
                    ...
                    "policy_seller_info": {
                        "type": "string",
                        "description": "The shop's seller infomation string (may be blank).",
                        "nullable": true
                    },
                    "policy_update_date": {
                        "type": "integer",
                    ...
                    "is_direct_checkout_onboarded": {
                        "type": "boolean",
                        "description": "(**DEPRECATED: Replaced by _is_etsy_payments_onboarded._) When true, the shop has onboarded onto Etsy Payments."
                    },
                    "is_etsy_payments_onboarded": {
                        "type": "boolean",
                    ...
                    "is_calculated_eligible": {
                        "type": "boolean",
                        "description": "When true, the shop is elegible for calculated shipping profiles. (Only available in the US and Canada)"
                    },
                    "is_opted_in_to_buyer_promise": {
                        "type": "boolean",
            ...
            "ShopProductionPartner": {
                ...
                "required": ["production_partner_id", "partner_name", "location"],
                "properties": {
            ...
            "ShopReceiptTransaction": {
                ...
                "properties": {
                    ...
                    "actual_ship_date": {
                        "type": "integer",
                        "description": "The date & time of the actual ship date, in epoch seconds.",
                        "nullable": true,
                        "minimum": 946684800
                    }
                }
            ...
            "SellerTaxonomyNode": {
                ...
                "properties": {
                    ...
                    "children": {
                        "type": "array",
                        "description": "An array of taxonomy nodes for all the direct children of this taxonomy node in the seller taxanomy tree.",
                        "items": {
                            "description": "An array of taxonomy nodes for all the direct children of this taxonomy node in the seller taxanomy tree.",
                            "allOf": [
                                {
            ...
            "ShopShippingProfile": {
                ...
                "properties": {
                    ...
                    "shipping_profile_destinations": {
                        "type": "array",
                        "description": "A list of [shipping profile destinations](/documentation/reference#operation/createListingShippingProfileDestination) available for this shipping profile.",
                        "items": {
                            "description": "A list of [shipping profile destinations](/documentation/reference#operation/createListingShippingProfileDestination) available for this shipping profile.",
                            "allOf": [
                                {
                    ...
                    "shipping_profile_upgrades": {
                        "type": "array",
                        "description": "A list of [shipping profile upgrades](/documentation/reference#operation/createListingShippingProfileUpgrade) available for this shipping profile.",
                        "items": {
                            "description": "A list of [shipping profile upgrades](/documentation/reference#operation/createListingShippingProfileUpgrade) available for this shipping profile.",
                            "allOf": [
                                {
            ...
            "ShopShippingProfileUpgrade": {
                ...
                "properties": {
                    ...
                    "language": {
                        "type": "string",
                        "description": "The IETF language tag for the language of the shipping profile. Ex: de, en, es, fr, it, ja, nl, pl, pt, ru."
                    },
                    "price": {
                        "description": "Additional cost of adding the shipping upgrade.",
                        "allOf": [
...
module.exports.openapi = openapistatus string of the payment adjustment."
                    },
                    "is_success": {
                        "type": "boolean",
                        "description": "When true, the payment adjustment was or is likely to complete successfully."
            ...
            "ShopReceipt": {
                ...
                "properties": {
                    ...
                    "payment_method": {
                        "type": "string",
                        "description": "The payment method string identifying purchaser's payment method, which must be one of: \\'cc\\' (credit card), \\'paypal\\', \\'check\\', \\'mo\\' (money order), \\'bt\\' (bank transfer), \\'other\\', \\'ideal\\', \\'sofort\\', \\'apple_pay\\', \\'google\\', \\'android_pay\\', \\'google_pay\\', \\'klarna\\', \\'k_pay_in_4\\' (klarna), or \\'k_financing\\' (klarna)."
                    },
                    "payment_email": {
                        "type": "string",
                        "description": "The email address string for the email address to which to send payment confirmation"
